<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Root.master" CodeBehind="Scheduler.aspx.cs" Inherits="charts.SchedulerModule" Title="Scheduler" %>

<%@ Register Assembly="DevExpress.Web.ASPxScheduler.v22.2, Version=22.2.5.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.ASPxScheduler" TagPrefix="dx" %>
...
<asp:Content ID="Content" ContentPlaceHolderID="PageContent" runat="server">
    ...
    <asp:ObjectDataSource ID="AppointmentDataSource" runat="server" DataObjectTypeName=" charts.Model.SchedulerAppointment"
        TypeName=" charts.Model.AppointmentDataSourceHelper"
    ...
    <asp:ObjectDataSource ID="ResourcesDataSource" runat="server" DataObjectTypeName=" charts.Model.SchedulerResource"
        TypeName=" charts.Model.ResourceDataSourceHelper"
